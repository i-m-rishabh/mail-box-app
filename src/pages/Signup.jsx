...
// AIzaSyB9m55G39buJUFJOZ8yb8lJGhbC_7hTtyg
    ...
    return(
        <div className=" flex flex-col justify-center items-center w-screen h-screen">
            <div className=" relative bg-primary py-10 px-10 rounded-xl flex flex-col justify-center items-center gap-5 text-white">
                <h2 className=" text-xl mb-5">SignUp</h2>
                {/* signup form */}
                <form className="flex flex-col gap-3" onSubmit={handleSignup}>
                    ...
                    <div className="flex justify-center mt-10">
                        <button type="submit" className=" bg-secondary py-1 px-2 rounded text-black">sign up</button>
                    </div>
                </form>
